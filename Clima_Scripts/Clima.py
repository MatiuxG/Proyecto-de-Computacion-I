...
# Cargamos las variables del archivo .env de la raíz del proyecto.
# Si python-dotenv no está instalado, el script igualmente intenta
# leer la variable de entorno normal (útil en CI/Docker).
try:
...
if not API_KEY:
    print("[ERROR] Falta AEMET_API_KEY. Configúrala en el archivo .env.")
    sys.exit(1)
