...
#dataset de ubicaciones de puntos de medida
...
def scrapper_informo_realtime():
    #descarga pm.xml (intensidad en tiempo real) y devuelve el df
...
def descargar_maestro_sensores():
    #devuelve un df con id_sensor e id_distrito desde el portal
...
def integrar_con_distritos(df_realtime):
    #cruza tiempo real con el maestro y calcula la media por distrito-dia
    df_final = pd.DataFrame()
    ...
    if maestro.empty:
        ...
        #el xml trae id como float y el csv como entero; los igualamos para el merge
...
if __name__ == "__main__":
    print("Iniciando Scraper de trafico en tiempo real...")
