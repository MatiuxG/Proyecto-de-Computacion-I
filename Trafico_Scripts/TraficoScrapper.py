...
def integrar_con_distritos(df_realtime):
    ...
    ruta_maestro = os.path.join(RAIZ, "DocumentacionNecesaria", "pmed_ubicacion_09-2025.csv")
    ...
    if os.path.exists(ruta_maestro):
        ...
        print(f"ATENCIÓN: No se encontró el maestro en {ruta_maestro}. No se pudo mapear distritos.")
